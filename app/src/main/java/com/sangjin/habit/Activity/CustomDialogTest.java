...
public class CustomDialogTest extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btn_customTest = findViewById(R.id.btn_customTest);
        btn_customTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CustomDialog oDialog = new CustomDialog(CustomDialogTest.this);
    ...
    public class CustomDialog extends Dialog
    {
        ...
        protected void onCreate(Bundle savedInstanceState)
        {
            ...
            Button oBtn = (Button)this.findViewById(R.id.btn_exit);
